...
class Widget01 extends Component {
    render() {
        const {className, cssModule, header, link, mainText, smallText, color, value, children, variant, ...attributes} = this.props;
        ...
        if (link) {
          return (
              <CardFooter className="px-3 py-2">
                <a className="font-weight-bold font-xs btn-block text-muted" href={link}>Подробнее
